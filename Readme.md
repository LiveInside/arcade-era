...
_Для отслеживания управления и применения изменений в базе данных используется библиотека Liquebase_
...
_Далее будут более подробно описаны основные методы. Примеры будут показаны на сущности `Games`._
...
* В случае успеха в базе данных будет обновлена запись по-заданному id на основе переданного клиентом тела. Вернётся код 201 и тело обновлённой игры в формате json.
